...
class ChessBoard:
    ...
    def is_draw(self, piece_color):
        if self.check_board.fifty_moves(self.fifty_moves_count):
            return "Draw with 'fifty moves' rule"
        elif self.check_board.five_same_moves(self.moves):
            return "Draw with 'five same moves' rule"
        elif self.check_board.stalemate(self.board, self.find_king(piece_color), piece_color):
            return "Draw with 'stalemate'"
        elif self.check_board.insufficient_pieces(self.board):
            return "Draw with 'not enough pieces'"
        else:
            return False
